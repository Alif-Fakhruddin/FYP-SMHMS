...
// ==========================================
// TETAPAN IP LAPTOP (TUKAR IP DI SINI)
// ==========================================
const String laptopIP = '10.47.12.48'; // Gantikan dengan IP Laptop anda
...
// ==========================================
// 3. TAB 1: DASHBOARD (AUTO-REFRESH & GEGARAN)
// ==========================================
...
class _DashboardPageState extends State<DashboardPage> {
  final String sensorUrl =
      'http://$laptopIP:5000/api/sensor?api_key=$apiKey';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (result['status'] == 'success' && mounted) {
          final String newStatus = result['data']['status_hazard'];
  ...
  void _silenceAlarm() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Amaran telah disenyapkan untuk demonstrasi.'),
              ...
              if (statusHazard == 'DANGER') ...[
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    icon: Icon(_isMuted ? Icons.volume_off : Icons.notifications_off),
                    label: Text(_isMuted ? 'AMARAN DISENYAPKAN' : 'HENTIKAN AMARAN (MUTE)'),
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _isMuted ? Colors.grey[700] : const Color(0xFFDC2626),
...
// ==========================================
// 4. TAB 2: SEJARAH SENSOR (HISTORY PAGE)
// ==========================================
...
// ==========================================
// 5. TAB 3: PROFIL PENGGUNA (PROFILE PAGE)
// ==========================================
